...
void DisplayInit() {
	SerialOut(F("Debug: Init OLED-Screen..."));
	display.init();
...
void DisplayDualSud(bool& DUALSUD) {
	SerialOut(F("Debug: DualSud-Screen..."));
	display.init();
	display.flipScreenVertically();
	display.setTextAlignment(TEXT_ALIGN_LEFT);
	display.setFont(ArialMT_Plain_16);
	display.clear();
	String Ausrichtung = "m";
	String Zeile1 = "DualSud";
	String Zeile2 = "ist";
	String Zeile3 = "";
	if (DUALSUD)
	{
		Zeile3 = "eingeschaltet";
	}
	else
	{
		Zeile3 = "ausgeschaltet";
	}
	String Zeile4 = "!!!";
	DisplayInfo(Ausrichtung, Zeile1, Zeile2, Zeile3, Zeile4);
	delay(2000);
...
void DisplayInfo(String &Ausrichtung, String &Zeile1, String &Zeile2, String &Zeile3, String &Zeile4) {
	...
	if (Ausrichtung == "m") {
		...
		_Spalte4 = (DisplayWidth - display.getStringWidth(Zeile4)) / 2;
	}
	...
	else if (Ausrichtung = "r")
	{
		...
		_Spalte4 = (DisplayWidth - display.getStringWidth(Zeile4)) - 5;
	}
...
void DisplayMenue(int &Menuepos) {
	...
	SerialOut(F("Debug: DisplayMenue ..."));
	int _Abstand = 15;
	int _S2 = 17;
	int _Z1 = 2;
	...
	if (Menuepos == oldMenuepos) {
		SerialOut(F("Debug: DisplayMenue return..."));
		//display.clear();
		return;
	}
	...
	switch (Menuepos) {
	case 1: //--------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Soll-Karbo");
		display.display();
		break;
	case 2: //--------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "K-Hysterese");
		display.display();
		break;
	case 3: //--------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "MessInterv.");
		display.display();
		break;
	case 4: //--------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Wifi STA");
		display.display();
		break;
	case 5: //--------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Wifi AP");
		display.display();
		break;
	case 6: //--------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Sud ID");
		display.display();
		break;
	case 7: //--------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Set Spun.ID");
		display.display();
		break;
	case 8: //--------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "IP Address");
		display.display();
		break;
	case 9: //--------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Save Config");
		display.display();
		break;
	case 10: //-------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Format SPIF");
		display.display();
		break;
	case 11: //-------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "STOP Spng");
		display.display();
		break;
	case 12: //-------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "START Spng");
		display.display();
		break;
	case 13: //-------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Druck-Komp.");
		display.display();
		break;
	case 14: //-------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Auto-Komp.");
		display.display();
		break;
	case 15: //-------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Test Ventil");
		display.display();
		break;
	case 16: //-------Max 11 Zeichen-"12345678901"
		display.drawString(_S2, _Z3, "Version");
		display.display();
		break;
	case 17: //-------Max 11 Zeichen-"12345678901"
...
void DisplayMenue(int& Menuepos, String& MenueTxt) {
	...
	display.drawString(2, _Z3, ">");
	display.drawString(117, _Z3, "<");
	display.drawString(_S2, _Z3, MenueTxt);
	display.display();
	oldMenuepos = Menuepos;
}